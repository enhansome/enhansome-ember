...
*You might also like [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,022 | 🐛 21 | 📅 2026-09-02.*
...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,874 | 🐛 106 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,041 | 🐛 152 | 🌐 JavaScript | 📅 2026-09-01 - A JavaScript codemod toolkit.
...
* [ember-simple-auth](https://github.com/simplabs/ember-simple-auth) ⭐ 1,907 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-03 - A library for implementing authentication/authorization in Ember.js applications.
...
* [ember-stargate](https://github.com/kaliber5/ember-stargate) ⭐ 69 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-04 - A modern take on using so called "portals" to render things in a different place of the DOM tree than they are logically defined in the app.
...
* [ember-decorators](https://github.com/ember-decorators/ember-decorators) ⭐ 357 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-03 - Useful decorators for Ember.js applications.
...
* [ember-intl](https://github.com/ember-intl/ember-intl) ⭐ 439 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 - Translate complex messages string. Localized formatting for date/time, number, and relative time.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,612 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-mobile-menu](https://github.com/nickschot/ember-mobile-menu) ⭐ 36 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-04 - Draggable sidebar specifically tailored to mobile devices.
...
* [ember-mobile-pane](https://github.com/nickschot/ember-mobile-pane) ⭐ 4 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - Mobile layout ember-mobile-pane.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-04 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03 - Do you have controllers that *only* parse query params?
...
* [ember-window-mock](https://github.com/kaliber5/ember-window-mock) ⭐ 64 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-04 - Use window global as an Ember.js service that can be mocked in tests.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,853 | 🐛 1,629 | 🌐 Go | 📅 2026-09-04
...
* [Frontile](https://github.com/josemarluedke/frontile) ⭐ 58 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-04 - Frontile aims to provide the legos (components, helpers, modifiers, and styles) necessary for building consistent and powerful Ember.js apps.
...
* [ember-language-server](https://github.com/emberwatch/ember-language-server) ⭐ 107 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-03 - Language Server Protocol implementation for Ember.js projects.
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,572 | 🐛 263 | 🌐 TypeScript | 📅 2026-09-04
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,207 | 🐛 1,432 | 🌐 Go | 📅 2026-09-03 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,690 | 🐛 113 | 🌐 Rust | 📅 2026-09-04 - [crates.io](https://crates.io)
...
* [skylines-project](https://github.com/skylines-project/skylines/tree/master/ember) ⭐ 408 | 🐛 107 | 🌐 Python | 📅 2026-09-04 - Live tracking, flight database and competition framework.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-04 - PIX.
