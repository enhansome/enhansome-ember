...
*You might also like [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,020 | 🐛 21 | 📅 2026-09-02.*
...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,850 | 🐛 106 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,042 | 🐛 154 | 🌐 JavaScript | 📅 2026-09-07 - A JavaScript codemod toolkit.
...
* [css-blocks](https://github.com/linkedin/css-blocks) ⭐ 6,287 | 🐛 189 | 🌐 TypeScript | 📅 2023-05-20 - High performance, maintainable stylesheets.
...
* [ember-apollo-client](https://github.com/bgentry/ember-apollo-client) ⭐ 280 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-06 - An ember-cli addon for Apollo Client and GraphQL.
...
* [immutable](https://github.com/facebook/immutable-js) ⭐ 33,034 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-03 - Immutable data collections.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,641 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-07 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-07 - Do you have controllers that *only* parse query params?
...
* [ember-fastboot](https://github.com/ember-fastboot/ember-cli-fastboot) ⭐ 849 | 🐛 153 | 🌐 JavaScript | 📅 2026-09-07 - Server-side rendering for Ember.js apps.
...
* [ember-exam](https://github.com/trentmwillis/ember-exam) ⭐ 289 | 🐛 29 | 🌐 JavaScript | 📅 2026-09-07 - Run your tests with randomization, splitting, and parallelization for beautiful tests.
...
* [ember-window-mock](https://github.com/kaliber5/ember-window-mock) ⭐ 64 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-07 - Use window global as an Ember.js service that can be mocked in tests.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,862 | 🐛 1,625 | 🌐 Go | 📅 2026-09-07
...
* [Frontile](https://github.com/josemarluedke/frontile) ⭐ 58 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-07 - Frontile aims to provide the legos (components, helpers, modifiers, and styles) necessary for building consistent and powerful Ember.js apps.
...
* [Front-End Performance Checklist](https://github.com/thedaviddias/Front-End-Performance-Checklist) ⭐ 17,330 | 🐛 0 | 📅 2025-03-23
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,572 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-07
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,216 | 🐛 1,433 | 🌐 Go | 📅 2026-09-07 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,692 | 🐛 111 | 🌐 Rust | 📅 2026-09-07 - [crates.io](https://crates.io)
...
* [Rancher](https://github.com/rancher/ui) ⭐ 622 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-25 - [Rancher](http://rancher.com) is enterprise management for Kubernetes.
...
* [skylines-project](https://github.com/skylines-project/skylines/tree/master/ember) ⭐ 408 | 🐛 107 | 🌐 Python | 📅 2026-09-07 - Live tracking, flight database and competition framework.
* [A list of open source Ember.js apps](https://github.com/EmberSherpa/open-source-ember-apps) ⭐ 236 | 🐛 1 | 📅 2021-04-29
* [emberclear](https://github.com/NullVoxPopuli/emberclear) ⭐ 198 | 🐛 176 | 🌐 TypeScript | 📅 2026-09-06 - Encrypted Chat. No History. No Logs.  + MU & TS.
...
* [Super Rentals](https://github.com/ember-learn/super-rentals) ⭐ 174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-07 - Super Rentals is a good starter project to get acclimated to the Ember.js way of doing things.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-07 - PIX.
