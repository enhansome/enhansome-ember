...
*You might also like [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,023 | 🐛 21 | 📅 2026-09-02.*
...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,215 | 🐛 105 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,038 | 🐛 152 | 🌐 JavaScript | 📅 2026-09-01 - A JavaScript codemod toolkit.
...
* [ember-simple-auth](https://github.com/simplabs/ember-simple-auth) ⭐ 1,908 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-01 - A library for implementing authentication/authorization in Ember.js applications.
...
* [ember-cli-update](https://github.com/ember-cli/ember-cli-update) ⭐ 279 | 🐛 79 | 🌐 JavaScript | 📅 2026-08-27 - Update Ember CLI Ember.js apps, addons and Glimmer.js apps.
...
* [ember-apollo-client](https://github.com/bgentry/ember-apollo-client) ⭐ 280 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01 - An ember-cli addon for Apollo Client and GraphQL.
...
* [ember-stargate](https://github.com/kaliber5/ember-stargate) ⭐ 69 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-31 - A modern take on using so called "portals" to render things in a different place of the DOM tree than they are logically defined in the app.
...
* [immutable](https://github.com/facebook/immutable-js) ⭐ 33,037 | 🐛 130 | 🌐 TypeScript | 📅 2026-08-27 - Immutable data collections.
...
* [vertical-collection](https://github.com/html-next/vertical-collection) ⭐ 181 | 🐛 60 | 🌐 JavaScript | 📅 2026-04-13 - Infinite Scroll and Occlusion at > 60 FPS.

### Internalization & Localization

* [ember-intl](https://github.com/ember-intl/ember-intl) ⭐ 439 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-01 - Translate complex messages string. Localized formatting for date/time, number, and relative time.
* [ember-intl-analyzer](https://github.com/simplabs/ember-intl-analyzer) ⭐ 50 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01 - Find unused translations in your Ember.js projects.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,595 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-01 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-31 - Do you have controllers that *only* parse query params?
...
* [ember-fastboot](https://github.com/ember-fastboot/ember-cli-fastboot) ⭐ 849 | 🐛 150 | 🌐 JavaScript | 📅 2026-08-28 - Server-side rendering for Ember.js apps.
...
* [ember-exam](https://github.com/trentmwillis/ember-exam) ⭐ 289 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-31 - Run your tests with randomization, splitting, and parallelization for beautiful tests.
...
* [ember-percy](https://github.com/percy/ember-percy) ⭐ 72 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-01 - Ember.js addon for visual regression testing with Percy.
* [ember-window-mock](https://github.com/kaliber5/ember-window-mock) ⭐ 64 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-02 - Use window global as an Ember.js service that can be mocked in tests.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,852 | 🐛 1,636 | 🌐 Go | 📅 2026-09-02
...
* [Frontile](https://github.com/josemarluedke/frontile) ⭐ 58 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-28 - Frontile aims to provide the legos (components, helpers, modifiers, and styles) necessary for building consistent and powerful Ember.js apps.
...
* [Front-End Performance Checklist](https://github.com/thedaviddias/Front-End-Performance-Checklist) ⭐ 17,329 | 🐛 0 | 📅 2025-03-23
...
* [Pragmatic, balanced FP in JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,737 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-26
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,569 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-02
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,193 | 🐛 1,431 | 🌐 Go | 📅 2026-09-01 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,690 | 🐛 108 | 🌐 Rust | 📅 2026-09-02 - [crates.io](https://crates.io)
...
* [skylines-project](https://github.com/skylines-project/skylines/tree/master/ember) ⭐ 407 | 🐛 107 | 🌐 Python | 📅 2026-09-02 - Live tracking, flight database and competition framework.
...
* [Super Rentals](https://github.com/ember-learn/super-rentals) ⭐ 174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-02 - Super Rentals is a good starter project to get acclimated to the Ember.js way of doing things.
...
* [API Docs](https://github.com/ember-learn/ember-api-docs) ⭐ 75 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-02 - This application was built to display our versioned API docs.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-02 - PIX.
