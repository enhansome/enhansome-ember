...
*You might also like [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,021 | 🐛 21 | 📅 2026-09-02.*
...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,466 | 🐛 106 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,041 | 🐛 153 | 🌐 JavaScript | 📅 2026-09-06 - A JavaScript codemod toolkit.
...
* [ember-simple-auth](https://github.com/simplabs/ember-simple-auth) ⭐ 1,907 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-06 - A library for implementing authentication/authorization in Ember.js applications.
...
* [css-blocks](https://github.com/linkedin/css-blocks) ⭐ 6,288 | 🐛 189 | 🌐 TypeScript | 📅 2023-05-20 - High performance, maintainable stylesheets.
...
* [ember-decorators](https://github.com/ember-decorators/ember-decorators) ⭐ 357 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-04 - Useful decorators for Ember.js applications.
...
* [immutable](https://github.com/facebook/immutable-js) ⭐ 33,035 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-03 - Immutable data collections.
...
* [ember-intl-analyzer](https://github.com/simplabs/ember-intl-analyzer) ⭐ 50 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-06 - Find unused translations in your Ember.js projects.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,628 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-mobile-pane](https://github.com/nickschot/ember-mobile-pane) ⭐ 4 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-04 - Mobile layout ember-mobile-pane.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-05 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-05 - Do you have controllers that *only* parse query params?
...
* [ember-fastboot](https://github.com/ember-fastboot/ember-cli-fastboot) ⭐ 849 | 🐛 151 | 🌐 JavaScript | 📅 2026-09-05 - Server-side rendering for Ember.js apps.
...
* [ember-test-selectors](https://github.com/simplabs/ember-test-selectors) ⭐ 262 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-04 - Enabling better element selectors in Ember.js tests.
...
* [ember-window-mock](https://github.com/kaliber5/ember-window-mock) ⭐ 64 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-05 - Use window global as an Ember.js service that can be mocked in tests.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,861 | 🐛 1,627 | 🌐 Go | 📅 2026-09-05
...
* [Frontile](https://github.com/josemarluedke/frontile) ⭐ 58 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-05 - Frontile aims to provide the legos (components, helpers, modifiers, and styles) necessary for building consistent and powerful Ember.js apps.
...
* [Pragmatic, balanced FP in JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,736 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-26
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,572 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-06
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,210 | 🐛 1,432 | 🌐 Go | 📅 2026-09-04 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,690 | 🐛 112 | 🌐 Rust | 📅 2026-09-06 - [crates.io](https://crates.io)
...
* [emberclear](https://github.com/NullVoxPopuli/emberclear) ⭐ 198 | 🐛 176 | 🌐 TypeScript | 📅 2026-09-04 - Encrypted Chat. No History. No Logs.  + MU & TS.
...
* [Super Rentals](https://github.com/ember-learn/super-rentals) ⭐ 174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-06 - Super Rentals is a good starter project to get acclimated to the Ember.js way of doing things.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-04 - PIX.
