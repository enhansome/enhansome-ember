...
*You might also like [awesome-javascript](https://github.com/sorrycc/awesome-javascript) ⭐ 35,025 | 🐛 23 | 📅 2026-09-08.*
...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,218 | 🐛 106 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,038 | 🐛 155 | 🌐 JavaScript | 📅 2026-09-11 - A JavaScript codemod toolkit.
...
* [ember-simple-auth](https://github.com/simplabs/ember-simple-auth) ⭐ 1,906 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-14 - A library for implementing authentication/authorization in Ember.js applications.
...
* [css-blocks](https://github.com/linkedin/css-blocks) ⭐ 6,284 | 🐛 189 | 🌐 TypeScript | 📅 2023-05-20 - High performance, maintainable stylesheets.
...
* [ember-decorators](https://github.com/ember-decorators/ember-decorators) ⭐ 357 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-14 - Useful decorators for Ember.js applications.
...
* [immutable](https://github.com/facebook/immutable-js) ⭐ 33,029 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-10 - Immutable data collections.
...
* [ember-intl](https://github.com/ember-intl/ember-intl) ⭐ 439 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 - Translate complex messages string. Localized formatting for date/time, number, and relative time.
* [ember-intl-analyzer](https://github.com/simplabs/ember-intl-analyzer) ⭐ 50 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-15 - Find unused translations in your Ember.js projects.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,715 | 🐛 406 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-15 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-14 - Do you have controllers that *only* parse query params?
...
* [ember-exam](https://github.com/trentmwillis/ember-exam) ⭐ 289 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-14 - Run your tests with randomization, splitting, and parallelization for beautiful tests.
...
* [ember-percy](https://github.com/percy/ember-percy) ⭐ 72 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-14 - Ember.js addon for visual regression testing with Percy.
* [ember-window-mock](https://github.com/kaliber5/ember-window-mock) ⭐ 64 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-14 - Use window global as an Ember.js service that can be mocked in tests.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,948 | 🐛 1,627 | 🌐 Go | 📅 2026-09-15
...
* [Frontile](https://github.com/josemarluedke/frontile) ⭐ 58 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-15 - Frontile aims to provide the legos (components, helpers, modifiers, and styles) necessary for building consistent and powerful Ember.js apps.
...
* [Front-End Performance Checklist](https://github.com/thedaviddias/Front-End-Performance-Checklist) ⭐ 17,340 | 🐛 0 | 📅 2025-03-23
...
* [Pragmatic, balanced FP in JavaScript](https://github.com/getify/Functional-Light-JS) ⭐ 16,732 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-26
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,570 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-15
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,245 | 🐛 1,435 | 🌐 Go | 📅 2026-09-15 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,699 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - [crates.io](https://crates.io)
...
* [skylines-project](https://github.com/skylines-project/skylines/tree/master/ember) ⭐ 408 | 🐛 108 | 🌐 Python | 📅 2026-09-15 - Live tracking, flight database and competition framework.
...
* [Super Rentals](https://github.com/ember-learn/super-rentals) ⭐ 174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-15 - Super Rentals is a good starter project to get acclimated to the Ember.js way of doing things.
...
* [API Docs](https://github.com/ember-learn/ember-api-docs) ⭐ 75 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-13 - This application was built to display our versioned API docs.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-15 - PIX.
