...
* Awesome Ember.js [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,569 | 🐛 105 | 📅 2026-09-02
  * [Contents](#contents)
  * [Packages](#packages)
    * [AST](#ast)
    * [a11y](#a11y)
...
* [jscodeshift](https://github.com/facebook/jscodeshift) ⭐ 10,039 | 🐛 152 | 🌐 JavaScript | 📅 2026-09-01 - A JavaScript codemod toolkit.
...
* [ember-django-adapter](https://github.com/dustinfarris/ember-django-adapter) ⭐ 192 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-02 - Ember CLI addon adapter for Django REST Framework.
...
* [ember-simple-auth](https://github.com/simplabs/ember-simple-auth) ⭐ 1,908 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-03 - A library for implementing authentication/authorization in Ember.js applications.
...
* [ember-cli-update](https://github.com/ember-cli/ember-cli-update) ⭐ 279 | 🐛 79 | 🌐 JavaScript | 📅 2026-09-02 - Update Ember CLI Ember.js apps, addons and Glimmer.js apps.
...
* [ember-apollo-client](https://github.com/bgentry/ember-apollo-client) ⭐ 280 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-03 - An ember-cli addon for Apollo Client and GraphQL.
...
* [source-map-explorer](https://github.com/danvk/source-map-explorer) ⭐ 3,934 | 🐛 57 | 🌐 TypeScript | 📅 2023-03-14 - Analyze and debug space usage through source maps.
...
* [ember-stargate](https://github.com/kaliber5/ember-stargate) ⭐ 69 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-02 - A modern take on using so called "portals" to render things in a different place of the DOM tree than they are logically defined in the app.
...
* [ember-decorators](https://github.com/ember-decorators/ember-decorators) ⭐ 357 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-02 - Useful decorators for Ember.js applications.
...
* [immutable](https://github.com/facebook/immutable-js) ⭐ 33,035 | 🐛 132 | 🌐 TypeScript | 📅 2026-09-03 - Immutable data collections.
...
* [ember-intl-analyzer](https://github.com/simplabs/ember-intl-analyzer) ⭐ 50 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-03 - Find unused translations in your Ember.js projects.
...
* [javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,599 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26 - Algorithms and data structures implemented in JavaScript with explanations and links to further readings.
...
* [ember-mobile-menu](https://github.com/nickschot/ember-mobile-menu) ⭐ 36 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-03 - Draggable sidebar specifically tailored to mobile devices.
...
* [ember-mobile-pane](https://github.com/nickschot/ember-mobile-pane) ⭐ 4 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-02 - Mobile layout ember-mobile-pane.
...
* [ember-style-modifier](https://github.com/jelhan/ember-style-modifier) ⭐ 38 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - This addon provides a {{style}} element modifier to set element's style.
...
* [ember-query-params-service](https://github.com/NullVoxPopuli/ember-query-params-service) ⭐ 58 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-02 - Do you have controllers that *only* parse query params?
...
* [ember-fastboot](https://github.com/ember-fastboot/ember-cli-fastboot) ⭐ 849 | 🐛 151 | 🌐 JavaScript | 📅 2026-09-03 - Server-side rendering for Ember.js apps.
...
* [ember-test-selectors](https://github.com/simplabs/ember-test-selectors) ⭐ 262 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-02 - Enabling better element selectors in Ember.js tests.
...
* [ember-percy](https://github.com/percy/ember-percy) ⭐ 72 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03 - Ember.js addon for visual regression testing with Percy.
...
* [Nomad UI](https://github.com/hashicorp/nomad/tree/master/ui) ⭐ 16,852 | 🐛 1,629 | 🌐 Go | 📅 2026-09-03
...
* [GitHub issues](https://github.com/emberjs/ember.js/issues) ⭐ 22,572 | 🐛 264 | 🌐 TypeScript | 📅 2026-09-03
...
* [Vault](https://github.com/hashicorp/vault/tree/master/ui/app) ⭐ 36,201 | 🐛 1,432 | 🌐 Go | 📅 2026-09-03 - A Tool for Managing Secrets (Hashicorp).
...
* [Rust Package Registry](https://github.com/rust-lang/crates.io) ⭐ 3,691 | 🐛 110 | 🌐 Rust | 📅 2026-09-03 - [crates.io](https://crates.io)
...
* [skylines-project](https://github.com/skylines-project/skylines/tree/master/ember) ⭐ 408 | 🐛 107 | 🌐 Python | 📅 2026-09-02 - Live tracking, flight database and competition framework.
...
* [Super Rentals](https://github.com/ember-learn/super-rentals) ⭐ 174 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03 - Super Rentals is a good starter project to get acclimated to the Ember.js way of doing things.
...
* [API Docs](https://github.com/ember-learn/ember-api-docs) ⭐ 75 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-03 - This application was built to display our versioned API docs.
...
* [PIX](https://github.com/1024pix/pix-editor) ⭐ 7 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-03 - PIX.
